        ...
        <div className="main flex">
            <section className='flex'>
                ...
                <article className='flex'>
                    <div className='flex'>
                        <Link className='text-hover' to='/review/katakana/pronuncia' onClick={() => {setChangedURL(true); playSound('change-page')}}>
                            <span className='text-shadow'>PRONUNCIA</span>
                            <i className='box-shadow'></i>
                        </Link>
                    </div>
                    <div className='flex'>
                        <Link className='text-hover' to='/review/katakana/escrita' onClick={() => {setChangedURL(true); playSound('change-page')}}>
