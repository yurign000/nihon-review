        ...
        <div className="mainAlphabets flex-center">
            <section className='flex-center'>
                ...
                <article className='flex-center'>
                    <div>
                        <Link className='text-hover text-shadow' to='/review/kanji/pronuncia' onClick={() => nextPage()}>
                            PRONUNCIA
                        </Link>
                    </div>
                    <div>
                        <Link className='text-hover text-shadow' to='/review/kanji/escrita' onClick={() => nextPage()}>
                            ESCRITA
                        </Link>
                    </div>
                    <div>
                        <Link className='text-hover text-shadow' to='/review/kanji/significado' onClick={() => nextPage()}>
                            SIGNIFICADO
                        </Link>
                    </div>
                </article>
